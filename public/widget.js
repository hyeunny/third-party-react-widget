(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("Widgeto", [], factory);
	else if(typeof exports === 'object')
		exports["Widgeto"] = factory();
	else
		root["Widgeto"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _widget = __webpack_require__(147);
	...
	exports.default = {
	    widget: {
	        render: function render(selector) {
	            _reactDom2.default.render(_react2.default.createElement(_widget2.default, null), document.querySelector(selector));
	        },
	        log: function log(alertText) {
	            alert(alertText);
	        }
	    }
	};
	  ...
	  _createClass(Widget, [{
	    ...
	    value: function css() {
	      return function () {
	        var _16 = {};
	        _16['font-size'] = '14px';
	        _16['margin-bottom'] = '3.5em';
	        _16['padding'] = '0';
	        _16['color'] = '#F00';
	        var _15 = {};
	        _15['padding'] = '1em';
	        _15['border'] = '3px solid #BADA55';
	        _15['background'] = '#FFF';
	        return [['.widget-container', _15], ['p', _16]];
	      }.apply(this);
	    }
	  }]);
